...
class ScenarioRoadTraffic(BaseScenario):
    ...
    def info(self, agent: Agent) -> Dict[str, Tensor]:
        ...
        if use_nod_actor:
            ...
            actor_base_dim = policy_observation_dim
            nod_actor_placeholders = {
                "nod_actor_observation": base_obs.new_zeros(
                    B, actor_base_dim + nod_message_dim + AGENTS["n_actions"]
                ),
        ...
        info = {
            ...
            **(
            ...
            # Policy-side nearest-neighbor identities are retained for diagnostics.
